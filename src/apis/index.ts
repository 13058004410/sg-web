...
export function ApiMemberGameListHistory() {
  return httpClient.get<CasinoLobbyGameItem[]>('/member/game/list/history')
}
...
export function ApiMemberNoticeList(params: {
  ...
  return httpClient.get<INoticeItem[]>('/member/notice/list', { params })
}
 ...
 */
export function ApiMemberNotifications() {
  return httpClient.get<{
    id: string
    type: string
    title: string
...
export function ApiBettingGameOriginalPlinko(data: {
  ...
  return httpClient.post('/game/original/plinko', data)
}
 ...
 */
export function ApiOriginalGameDetail(id: string) {
  return httpClient.get<IOriginalGameDetail>('/game/original/game/detail', { params: { id } })
}
 ...
 */
export function ApiMemberChannelNavLocation() {
  return httpClient.get<number>('/member/channel/nav/location', { params: { auth: false } })
}

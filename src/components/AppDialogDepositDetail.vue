...
const getAmount = computed(() => {
  ...
  return (isDeposit.value && data.state === 1) ? data.finally_amount : (data.pay_amount ?? data.finally_amount)
})
    ...
    <div class="content">
      ...
      <div class="item">
        ...
        <div class="center" style="gap: var(--tg-spacing-4);">
          ...
          <span class="data">{{ isDeposit ? formatDepositState(data.state) : formatWithdrawState(data.state) }}</span>
        </div>
      </div>
      <div class="item">

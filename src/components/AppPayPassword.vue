  ...
  <div class="tg-settings-security">
    ...
    >
      ...
      <div v-if="getMailState" class="mail-not-bind">
        <div>{{ t('settings_change_password_funds_password_not_bind_email') + t('settings_change_password_funds_password_must_bind_email') }}</div>
      ...
      <template v-else>
        ...
        <BaseLabel :label="t('pop_up_wallet_card_set_funds_password_email_code')">

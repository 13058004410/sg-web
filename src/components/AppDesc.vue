...
function checkPlatGameList() {
  if (props.isOriginalGame)
    ...
    push(`/casino/group/provider?vid=${props.vid}`)
}
...
setTimeout(() => {
  runAsyncMemberBetList({
    ...
    luckyFactor.value = list.value[0]?.factor
  })
}, 500)
</script>
  ...
  >
    <div class="desc-title">
      <div class="title-left">
        ...
        <span
          class="plat-name"
          @click="checkPlatGameList"
        >
          {{ platName }}
        </span>
      </div>
      <div class="title-right">
        <div v-if="!isXs && list.length" class="r-status">
          <BaseIcon name="uni-cup1" />
          <span v-if="list">{{ application.numberToLocaleString(Number(luckyFactor ?? 0)) }}x</span>
        ...
        <div class="c-text">
          ...
          <div class="text">
            ...
            <p>
              ...
              Cursed Seas slot at {{ VITE_OFFICIAL_NAME }} Casino.
            </p>
            <p>

  ...
  <div class="base-input">
    <div :class="[layout]" @click="catchIt">
      ...
      <div class="input-wrap" :class="{ mb0 }">
        <div
          ref="inputBoxRef" class="input-box" :class="{
            'active': isFocus,
            'error': error && !isFocus,
        ...
        >
          ...
          <div v-if="textarea" class="textarea-container">
            ...
            <textarea
              ...
              :placeholder="placeholder" :class="{ 'p-r-0': $slots['right-icon'] }" autocomplete="new-password"
              :disabled="disabled" :readonly="readonly" @input="onInput" @focus="onFocus" @keydown.enter="keyDownEnter"
              @paste="onPaste" @compositionstart="onCompositionStart" @compositionend="onCompositionEnd"
            />
          </div>
          <input
            v-else ref="iInput" :value="modelValue" min="0" :maxlength="max" :placeholder="placeholder" :type="_type"
            ...
            @keydown.enter="keyDownEnter" @compositionstart="onCompositionStart" @compositionend="onCompositionEnd"
          >
        ...
        <div v-show="$slots['right-button']" class="right-button" @click.stop="onRightButton">
          <div class="content">
...
:root {
  ...
  --tg-base-input-right-button-hover-bg: var(--tg-text-grey);

...
const menuData = computed(() => [
  ...
  },
  {
    ...
    children: [
      ...
      { title: t('footer_affiliate'), path: '/affiliate/promotion-tutorial' },
      { title: t('responsible_casino'), path: '/responsible-gambling/safe' },
      // { title: t('gameble_aware'), icon: true },
      { title: t('h5_footer_navigation_live_support'), onClick: () => openService() },
  ...
  <div class="app-footer">
    ...
    <div class="footer-copyright">
      ...
      <div class="copy-right">
        © 2024 {{ VITE_OFFICIAL_DOMAIN }} | {{ t('footer_under_logo_copyright') }}
      </div>
      <div>

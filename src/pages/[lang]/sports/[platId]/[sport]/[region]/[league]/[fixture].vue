...
// 娱乐城近期近期游戏记录
const { data: gameHistoryData } = useRequest(ApiMemberGameListHistory, {
  manual: false,
  ready: isLogin,
})
const gameHistoryList = computed(() => gameHistoryData.value ? gameHistoryData.value.slice(0, 3) : [])
              ...
              <div v-if="showRecent" class="is-open spotlight variant-dark">
                ...
                <div class="content is-open">
                  <div class="wrapper">
                    ...
                    >
                      <div v-for="item in gameHistoryList" :key="item.id" class="item">

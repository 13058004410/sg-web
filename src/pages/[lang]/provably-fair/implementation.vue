...
<template>
  <div>
    ...
    <div class="text-tg-secondary-light mt-16 text-[16px] leading-[1.5] md:text-[18px]">
      For each verifiable bet, a client seed, a server seed, a nonce and a cursor are used as the input parameters for the <a class="text-tg-text-white text-[14px]" href="https://en.wikipedia.org/wiki/Random_number_generation" target="_blank">random number generation <BaseIcon class="text-[12px]" name="uni-jump-page" /></a> function. This function utilises the cryptographic hash function <a class="text-tg-text-white text-[14px]" href="https://en.wikipedia.org/wiki/HMAC" target="_blank">HMAC_SHA256 <BaseIcon class="text-[12px]" name="uni-jump-page" /></a> to generate bytes which are then used as the foundation for how we generate provably fair random outcomes on our platform.
    </div>
...
function byteGenerator({ serverSeed, clientSeed, nonce, cursor }) {
  ...
  while (true) {
    ...
    <div class="text-tg-text-white mt-16 text-[18px] font-semibold leading-[1.32]">
      Games with more than 1 incremental number:
    </div>
    <ul class="ml-[32px] mt-16 list-disc text-[16px] leading-[1.32] md:text-[18px]">
      <!-- <li class="mb-8">
    ...
    <ul class="ml-[32px] mt-16 list-disc text-[16px] md:text-[18px]">
      <li class="mb-8 leading-[1.32]">
        Dice
      </li>
      <li class="mb-8 leading-[1.32]">
        Limbo

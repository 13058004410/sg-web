...
<template>
  <div>
    ...
    <div class="text-tg-secondary-light mt-16 text-[16px] leading-[1.5] md:text-[18px]">
    ...
    <div class="text-tg-text-white mt-16 text-[20px] font-semibold leading-[1.32] md:text-[28px]">
      Dice Roll
    </div>
    <div class="text-tg-secondary-light mt-16 text-[16px] leading-[1.5] md:text-[18px]">
    ...
    <div class="text-tg-text-white bg-tg-secondary-grey scroll-x mt-16 rounded-[4px] p-16 text-[16px] leading-[1.5] md:text-[18px]">
...
const roll = (float * 10001) / 100;</code></pre>
    ...
    <div class="text-tg-secondary-light mt-16 text-[16px] leading-[1.5] md:text-[18px]">
      When it comes to Limbo, we use a two-step process. Firstly, we take the float and multiply it by both the maximum possible multiplier and the house edge. Then, in order to generate a game event that has <a class="text-tg-text-white text-[14px]" href="https://en.wikipedia.org/wiki/Probability_distribution" target="_blank">probability distribution <BaseIcon class="text-[12px]" name="uni-jump-page" /></a> , we divide the maximum possible multiplier by the result of the first step to create the game event in the form of a crash point.
    </div>
    <div class="text-tg-text-white bg-tg-secondary-grey scroll-x mt-16 rounded-[4px] p-16 text-[16px] leading-[1.5] md:text-[18px]">

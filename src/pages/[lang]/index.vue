...
usePageTitle({
  prefix: t('index_title_prefix', { site: VITE_OFFICIAL_NAME }),
...
const hostSite = computed(() => (
  { host: location.value.hostname?.replace('www.', ''), site: VITE_OFFICIAL_NAME }
))
      ...
      <div class="introduction-content" :class="{ 'column-count': !isSm }">
        <p>
          {{ t('company_intro_tip_1',
               hostSite, { site: VITE_OFFICIAL_NAME }, { domain: VITE_OFFICIAL_DOMAIN }) }}
        </p>
        <p>

...
<template>
  <div class="content-block pd-24">
    ...
    <div class="p">
      At {{ VITE_OFFICIAL_NAME }}, we want to be an industry leader in providing a safe environment for our customers. We actively encourage and promote responsible gambling practices and provide tools to assist our customers in maintaining control of their gambling.
    </div>
    ...
    <div class="p">
      In the case of needed help please contact our support team at support@{{ VITE_OFFICIAL_DOMAIN }} or on our live chat system and one of our agents will be able to give you the details of associations and help phone numbers available in your country.
    </div>
